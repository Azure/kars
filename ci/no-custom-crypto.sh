...
ALLOW_PATHS=(
  ...
  # `kars-a2a-core` workspace member so the new public-edge `a2a-gateway` shares
  ...
  'kars-a2a-core/src/agent_card.rs'        # see inference-router/src/a2a/agent_card.rs above
  'kars-a2a-core/src/card_signing.rs'      # see inference-router/src/a2a/card_signing.rs above
  'kars-a2a-core/src/card_verifier.rs'     # see inference-router/src/a2a/card_verifier.rs above
  'kars-a2a-core/src/signature.rs'         # RFC 7515 base64url + signing-input helper; no crypto math
  ...
  'controller/src/kars_memory_compile.rs'      # KarsMemory binding compile (S5)
  'controller/src/kars_eval_compile.rs'        # KarsEval suite compile (S6)
