...
| [`lethal-trifecta-demo`](lethal-trifecta-demo/) | OpenClaw (×2) | Reproduces the [Claude Cowork file-exfiltration attack](https://www.promptarmor.com/resources/claude-cowork-exfiltrates-files) (Jan 2026) on a vanilla OpenClaw vs. a kars-managed agent. Six independent layers — each one alone catches the attack. **Recommended launch demo.** |
