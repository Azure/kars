...
Status: **Both bounded source reviews closed; actual native diagnosis remains open.**
...
The next native execution must provide actual comparison evidence; even then,
boolean differences do not prove which admission plugin ran.
